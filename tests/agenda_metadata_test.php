...
final class metadata_test extends \advanced_testcase {
    ...
    /**
     * Test persistence in the existing Designer options table.
     *
     * @return void
     */
    public function test_save_and_get_for_cmid_preserves_other_options(): void {
        ...
        \format_designer\options::insert_option($module->cmid, $course->id, 'existingoption', 'keep me');
        ...
        $this->assertSame('keep me', $DB->get_field('format_designer_options', 'value', [
            'cmid' => $module->cmid,
            'name' => 'existingoption',
        ]));
    }
    ...
    public function test_save_empty_data(): void {
        ...
        $this->assertTrue($DB->record_exists('format_designer_options', [
            'cmid' => $module->cmid,
