...
namespace format_designeragenda\external;
...
trait set_section_options {
    ...
    public static function set_section_options(int $courseid, int $sectionid, array $options) {
        ...
        require_capability('format/designeragenda:changesectionoptions', $context);
    ...
    public static function get_module($id, $sectionid, $sectionreturn = null) {
        ...
        $renderer = $PAGE->get_renderer('format_designeragenda');

        $format = course_get_format($course);
        $sectiontype = $format->get_section_option($sectionid, 'sectiontype') ?: get_config('format_designeragenda', 'sectiontype');
