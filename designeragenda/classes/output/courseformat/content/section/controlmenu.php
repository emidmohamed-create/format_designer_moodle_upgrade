...
namespace format_designeragenda\output\courseformat\content\section;
...
class controlmenu extends controlmenu_base {
    ...
    public function export_for_template(\renderer_base $output): stdClass {
        ...
        if (($course->coursedisplay == COURSE_DISPLAY_MULTIPAGE && !$sectionnum)
            || $course->coursetype == DESIGNERAGENDA_TYPE_FLOW) {
        ...
        $sectiontypes = [];
        if (!format_designeragenda_is_support_subpanel()) {

            $sectiontypes = [
                [
                    'type' => 'default',
                    'name' => get_string('link', 'format_designeragenda'),
                ...
                [
                    'type' => 'list',
                    'name' => get_string('list', 'format_designeragenda'),
                    'active' => $this->format->get_section_option($section->id, 'sectiontype') == 'list',
                    'url' => new moodle_url('/course/view.php', ['id' => $course->id], 'section-' . $section->section),
                ],
                [
                    'type' => 'cards',
                    'name' => get_string('cards', 'format_designeragenda'),
        ...
        $data = (object) [
            ...
            'is_subpanel' => format_designeragenda_is_support_subpanel(),
    ...
    public function section_control_items() {
        ...
        if (!$isstealth && has_capability('moodle/course:update', $coursecontext, $user)) {
            ...
            if (format_designeragenda_is_support_subpanel() && $hassectiontypes) {
                $controls['sectionlayout'] = new action_menu_subpanel(
                    get_string('strsectionlayout', 'format_designeragenda'),
                    $this->get_choice_list($section),
                    ['data-value' => 'section-designeragenda-action'],
        ...
        if (
            ...
            $controls['permalink'] = [
                'url' => $sectionlink,
                'icon' => 'i/link',
                'name' => get_string('sectionlink', 'format_designeragenda'),
                'pixattr' => ['class' => ''],
                'attr' => [
                    'class' => 'icon',
    ...
    public function get_choice_list($section): choicelist {
        ...
        $sectiontype = $sectiontype ? $sectiontype : get_config('format_designeragenda', 'sectiontype');
