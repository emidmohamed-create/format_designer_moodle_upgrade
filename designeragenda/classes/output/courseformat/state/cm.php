...
namespace format_designeragenda\output\courseformat\state;
use stdClass;
...
class cm extends \core_courseformat\output\local\state\cm {
    ...
    public function export_for_template(\renderer_base $output): stdClass {
        ...
        $usecourseindexcustom = \format_designeragenda\options::get_option($cm->id, 'customtitleusecourseindex');
