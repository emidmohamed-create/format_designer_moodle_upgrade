...
class events {
    ...
    public static function course_section_created($event) {
        ...
        $option = get_config('format_designeragenda', 'sectiondesignerbackgroundimage');
        $coursecontext = \context_course::instance($courseid);

        if (course_get_format($courseid)->get_course()->format !== 'designeragenda') {
            return true;
        }
        ...
        foreach ($options as $name => $option) {
            if (get_config('format_designeragenda', $name)) {
                $sectiondata[$name] = get_config('format_designeragenda', $name);
            }
        }
    ...
    /**
     * After course deleted, deleted the format_designeragenda_options data related to the format_designeragenda options.
     *
     * @param object $event
     * @return void
     */
    public static function course_deleted($event) {
        ...
        $DB->delete_records('format_designeragenda_options', ['courseid' => $courseid]);
    ...
    /**
     * After course module deleted, deleted the format_designeragenda_options data related to the format_designeragenda options.
     *
     * @param object $event
     * @return void
     */
    public static function course_module_deleted($event) {
        ...
        $cmid = $event->objectid;
        $DB->delete_records('format_designeragenda_options', ['courseid' => $courseid, 'cmid' => $cmid]);
