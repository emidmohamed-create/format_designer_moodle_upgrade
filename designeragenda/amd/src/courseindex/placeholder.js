 ...
 *
 * @module     format_designeragenda/courseindex/placeholder
...
export default class DesignerAgendaComponent extends Component {
    /**
    ...
    static init(target, selectors) {
        return new DesignerAgendaComponent({
    ...
    async loadTemplateContent(state) {
        ...
        try {
            ...
            const {html, js} = await Templates.renderForPromise(
                'format_designeragenda/courseformat/courseindex/courseindex',
                data,
            );
