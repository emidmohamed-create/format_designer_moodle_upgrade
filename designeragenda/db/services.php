...
$functions = [
    'format_designeragenda_set_section_options' => [
        'classpath'     => '',
        'classname'     => 'format_designeragenda\external\external',
        'methodname'    => 'set_section_options',
        'description'   => 'Set section options.',
        'type'          => 'write',
        'ajax'          => true,
    ],
    'format_designeragenda_get_module' => [
        'classpath'     => '',
        'classname'     => 'format_designeragenda\external\external',
    ...
    'format_designeragenda_section_refresh' => [
        'classpath'     => '',
        'classname'     => 'format_designeragenda\external\external',
    ...
    'format_designeragenda_get_videotime_instace' => [
        'classpath'     => '',
        'classname'     => 'format_designeragenda\external\external',
