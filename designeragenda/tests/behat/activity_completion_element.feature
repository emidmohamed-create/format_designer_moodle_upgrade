@format @format_designeragenda @javascript
Feature: Sections can be check activity completion element in designeragenda format
  In order to rearrange my course contents
  As a teacher
  I need to check activiyt completion in designeragenda format
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | designeragenda | 0             | 5           | yes                      |
  ...
  Scenario: Check the manual mark completion the activity
    ...
    Then I set the designeragenda manual completion
