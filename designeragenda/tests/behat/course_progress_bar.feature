@format @format_designeragenda @course_progress_bar @javascript
Feature: Course progress bar checking criteria in designeragenda format
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | designeragenda | 0             | 5           | 1              |  1        |
      | Course 2 | C2        | designeragenda | 0             | 5           | 1              |  1        |
      | Course 3 | C3        | designeragenda | 0             | 5           | 1              |  1        |
      | Course 4 | C4        | designeragenda | 0             | 5           | 1              |  1        |
      | Course 5 | C5        | designeragenda | 0             | 5           | 1              |  1        |
  ...
  Scenario: Display the course completion progress sorted by completion date
    ...
    Then I set the designeragenda completion expected "##1 Feb 2024 08:00##"
    And I press "Save and display"
    And I log out
