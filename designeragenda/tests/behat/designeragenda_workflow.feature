@format @format_designeragenda @javascript @designeragenda_workflow
Feature: Check other workflow actions in designeragenda format
  In order to rearrange my course contents
  As a teacher
  I need to check workflow actions in designeragenda format
