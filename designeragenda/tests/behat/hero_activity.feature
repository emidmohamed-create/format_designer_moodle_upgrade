@format @format_designeragenda @javascript @designeragenda_hero_activity
Feature: Activities can be check hero activity in designeragenda format
  In order to rearrange my course contents
  As a teacher
  I need to check hero activity in designeragenda format
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 2 | C2        | designeragenda | 0             | 5           | yes                      |
