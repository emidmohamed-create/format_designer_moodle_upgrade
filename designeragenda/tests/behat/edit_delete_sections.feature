@format @format_designeragenda
Feature: Sections can be edited and deleted in designeragenda format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete designeragenda
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | designeragenda | 0           | 5           |
  ...
  Scenario: View the default name of the general section in designeragenda format
    When I edit the section "0"
    Then I check the designeragenda section general section

  Scenario: Edit section summary in designeragenda format
    When I edit the section "2" and I fill the form with:
      | Summary | Welcome to section 2 |
    Then I should see "Welcome to section 2" in the "li#section-2" "css_element"

  @javascript
  Scenario: Inline edit section name in designeragenda format
    When I set the field "Edit designeragenda section name" in the "li#section-1" "css_element" to "Midterm evaluation"
  ...
  Scenario: Deleting the last section in designeragenda format
  ...
  @javascript
  Scenario: Adding sections in designeragenda format
