...
$string['designeragenda:changesectionoptions'] = 'Change section options, such as type.';
...
$string['page-course-view-designeragenda'] = 'Any course main page in Designer Agenda format';
$string['page-course-view-designeragenda-x'] = 'Any course page in Designer Agenda format';
$string['pluginname'] = 'Designer Agenda';
...
$string['completionicons_help'] = 'Completion info based on Designer Agenda format';
...
$string['configtitle'] = 'Designer Agenda default options';
$string['generalsettings'] = 'General Designer Agenda settings';
...
$string['agendainformation'] = 'Pedagogical agenda information';
$string['editagendainformation'] = 'Edit agenda information';
$string['editagendacard'] = 'Edit agenda information';
$string['agendaupdated'] = 'Agenda information updated.';
$string['agendamodality'] = 'Modality';
$string['agendamodality_onsite'] = 'On-site';
$string['agendamodality_online_sync'] = 'Online synchronous';
$string['agendamodality_online_async'] = 'Online asynchronous';
$string['agendamodality_hybrid'] = 'Hybrid';
$string['agendapedagogicaltype'] = 'Pedagogical type';
$string['agendapedagogicaltype_course'] = 'Course';
$string['agendapedagogicaltype_workshop'] = 'Workshop';
$string['agendapedagogicaltype_lab'] = 'Lab';
$string['agendapedagogicaltype_project'] = 'Project';
$string['agendapedagogicaltype_assessment'] = 'Assessment';
$string['agendapedagogicaltype_resource'] = 'Resource';
$string['agendapedagogicaltype_support'] = 'Support';
$string['agendatimestart'] = 'Start time';
$string['agendatimeend'] = 'End time';
$string['agendatimestartplaceholder'] = '09:00';
$string['agendatimeendplaceholder'] = '10:30';
$string['agendaduration'] = 'Estimated duration (minutes)';
$string['agendadurationplaceholder'] = 'e.g. 60';
$string['agendalocation'] = 'Location';
$string['agendameetingurl'] = 'Video conference link';
$string['agendadeliverable'] = 'Expected deliverable';
$string['agendapracticalinfo'] = 'Practical information';
$string['invalidagendamodality'] = 'Select a valid modality.';
$string['invalidagendapedagogicaltype'] = 'Select a valid pedagogical type.';
$string['invalidagendatime'] = 'Enter a valid time in HH:MM format.';
$string['agendaendbeforestart'] = 'The end time must be after the start time.';
$string['invalidagendaduration'] = 'Enter a duration between 0 and 1440 minutes.';
$string['invalidagendameetingurl'] = 'Enter a valid HTTP or HTTPS link.';
$string['agendaschedule'] = 'Schedule';
$string['agendadurationminutes'] = '{$a} minutes';
